const scripts = [
  ...
  { id: "solid3d", category: "도형", name: "입체 도형 (3D → 2D 라인)", file: "01_도형/Object_Solid3D.jsx", summary: "직육면체·정사면체·정팔면체·정십이면체·정이십면체·각기둥·각뿔·각뿔대·원기둥·원뿔·원뿔대·빨대(속 빈 원기둥)를 만들고 가로 회전·위아래 기울기·화면 회전으로 원하는 시점을 잡아 2D 라인 드로잉으로 남깁니다. 숨은선은 파선·실선·생략 중 고르고, 평행 투영과 원근을 지원합니다. 면 채우기는 없음·단일 음영·광원 자동(화면 기준 광원으로 면마다 K값 산출, 밝기·대비·광원 방위·높이 조절) 중 고릅니다.", tags: ["입체", "3D", "숨은선", "음영", "정다면체", "원기둥", "원뿔"] },
  { id: "revolve3d", category: "도형", name: "회전체 (3D → 2D 라인)", file: "01_도형/Object_Revolve3D.jsx", summary: "단면 패스와 축이 될 직선(앵커 2개) 두 개를 선택하고 실행하면 단면을 축 둘레로 돌린 회전체를 2D 라인 드로잉으로 만듭니다. 사각형에 접한 축이면 원기둥, 원과 떨어진 축이면 도넛, 곡선 병 모양도 됩니다. 위아래 기울기·화면 회전·커스텀 프리셋·원근으로 시점을 잡고, 숨은선은 파선·실선·생략 중 고릅니다. 도넛처럼 볼록하지 않은 도형도 광선 교차로 숨은선을 정확히 가릅니다. 면 채우기는 없음·단일 음영·광원 자동(화면 기준 광원으로 단면 조각마다 K값 산출, 밝기·대비·광원 방위·높이 조절) 중 고르며, 곡면은 조각 수만큼 단계가 지는 음영이 됩니다. 확인하면 원본 단면과 축은 지워집니다.", tags: ["입체", "3D", "회전체", "숨은선", "음영", "원기둥", "도넛"] },
  { id: "extrude3d", category: "도형", name: "돌출 (3D → 2D 라인)", file: "01_도형/Object_Extrude3D.jsx", summary: "선택한 패스를 그대로 앞뒤로 밀어 만든 기둥을 2D 라인 드로잉으로 만듭니다. 닫힌 패스는 앞뒤 뚜껑이 있는 기둥, 열린 패스는 뚜껑 없는 띠가 되고, 여러 개를 함께 선택하면 겹친 안쪽이 구멍(파이프·도넛)이 됩니다. 깊이(mm)와 가로 회전·위아래 기울기·화면 회전·커스텀 프리셋·원근으로 시점을 잡고, 숨은선은 파선·실선·생략 중 고릅니다. 별·ㄱ자처럼 볼록하지 않은 단면도 광선 교차로 숨은선을 정확히 가릅니다. 면 채우기는 없음·단일 음영·광원 자동(밝기·대비·광원 방위·높이 조절) 중 고릅니다. 확인하면 원본 패스는 지워집니다.", tags: ["입체", "3D", "돌출", "익스트루드", "숨은선", "음영", "파이프"] },
