const scripts = [
  ...
  { id: "pedigree", category: "도형", name: "가계도", file: "01_도형/Object_Pedigree.jsx", summary: "선택한 사각형 중앙에 조부모·부모·형제·자녀 가계도를 그립니다. 친가·외가 형제를 각 3명까지 추가하고, 구성원마다 (가) 사선·(나) 격자·둘 다 20% 음영 발현과 ⓐⓑⓒ 원문자 가림을 정합니다. 도형 크기, 부부·형제·세대 간격, 형제 분기점을 조절하면 번호가 왼쪽부터 자동으로 붙습니다.", tags: ["과학", "생물", "유전"] },
