const scripts = [
  ...
  { id: "sine-wave", category: "도형", name: "사인 곡선", file: "01_도형/Object_SineWave.jsx", summary: "선택한 패스를 축으로 삼아 sin 곡선을 만듭니다. 직선은 그대로, 곡선·원은 그 곡선을 따라 파형이 감깁니다. 진폭·파장·축 이동·선 두께를 조절합니다.", tags: ["과학", "파동"] },
