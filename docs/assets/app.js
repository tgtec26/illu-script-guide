const scripts = [
  { id: "setup", category: "세팅", name: "setup", file: "00_세팅/setup.jsx", summary: "새 PC에서 Illustrator 환경을 한 번에 맞춥니다. 단위, 키보드 증감, 문자 증감, 고정점 표시, 액션 세트를 적용합니다.", tags: ["환경설정", "액션", "새 PC"] },
  {
    ...
    summary: "원자 모형·분자 모형·이온 결합 모형 생성기를 한 창의 탭으로 묶은 스크립트입니다. 세 탭이 옵션과 크기를 같이 쓰고, 실시간 미리보기를 지원합니다.",
    ...
    tabs: [
      { id: "atom", name: "원자", summary: "H~Ar 원소를 다중 선택해 원자 모형을 그립니다. 이온 전하(-3~+3), 1번 껍질 수평 배열, 2·3번 껍질 22.5° 이동을 고릅니다." },
  ...
  },
  {
    ...
    summary: "축 눈금·그래프 마커·표·점선 분할선·모델 곡선을 한 창의 탭으로 묶은 스크립트입니다. 각 탭의 코드와 저장 키는 원래 스크립트 그대로입니다.",
    requires: "탭마다 필요한 선택이 다릅니다. 선택에 맞지 않는 탭은 흐리게 표시되고 툴팁에 이유가 적힙니다.",
    tags: ["그래프", "축", "눈금", "마커", "과학", "표", "정렬", "점선", "분할", "곡선", "정규분포", "생장", "하디바인베르크", "생명", "화학"],
    tabs: [
