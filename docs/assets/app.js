const scripts = [
  ...
  { id: "smooth-path", category: "도형", name: "패스 정리 (앵커 제거·부드럽게)", file: "01_도형/Object_SmoothPath.jsx", summary: "패스를 정리합니다. 두 탭으로 나뉩니다. [앵커 제거] 원본 핸들을 그대로 두고, 빼도 허용 오차(mm) 안에 맞는 고정점만 삭제 — VectorFirstAid의 Super Smart Remove 방식. 수천 패스·수만 앵커를 다루므로 미리보기 없이 확인 때 한 번에 적용합니다. [부드럽게] 연필로 그린 패스용. 앵커 줄이기(허용 오차 안에서 필요 없는 고정점 삭제)와 곡선 다듬기(꺾인 곳과 곡률이 튀는 곳을 펴서 부드럽게)를 0~100 강도로 각각 조절하고, 모서리 유지 각도보다 급하게 꺾인 점만 모서리로 남깁니다. 세포막처럼 크기가 중요한 그림이 쪼그라들지 않도록 평활은 면적을 지키는 방식입니다. 부드럽게 탭은 미리보기가 선택한 패스에 바로 적용되고, 취소하면 원래 좌표로 돌아갑니다.", tags: ["연필", "곡선", "앵커", "단순화", "세포막", "트레이스", "앵커 제거"] },
