const scripts = [
  ...
  { id: "revolve3d", category: "도형", name: "회전체 (3D → 2D 라인)", file: "01_도형/Object_Revolve3D.jsx", summary: "단면 패스와 축이 될 직선(앵커 2개) 두 개를 선택하고 실행하면 단면을 축 둘레로 돌린 회전체를 2D 라인 드로잉으로 만듭니다. 사각형에 접한 축이면 원기둥, 원과 떨어진 축이면 도넛, 곡선 병 모양도 됩니다. 위아래 기울기·화면 회전·커스텀 프리셋·원근으로 시점을 잡고, 숨은선은 파선·실선·생략 중 고릅니다. 도넛처럼 볼록하지 않은 도형도 광선 교차로 숨은선을 정확히 가릅니다. 확인하면 원본 단면과 축은 지워집니다.", tags: ["입체", "3D", "회전체", "숨은선", "원기둥", "도넛"] },
