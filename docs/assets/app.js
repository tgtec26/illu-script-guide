const scripts = [
  ...
  { id: "convection", category: "도형", name: "대류 순환 화살표", file: "01_도형/Object_Convection.jsx", summary: "선택한 개체(비커·사각형 등)의 경계 상자 안에 대류 고리를 그립니다. 가운데를 가열하면 두 고리가 가운데로 올라가 옆면을 따라 내려오고, 왼쪽·오른쪽을 가열하면 고리 하나가 가열한 쪽으로 올라갑니다. 고리는 둥근 사각형을 네 변으로 끊은 선이고 변마다 끝에 화살촉이 붙습니다. 안쪽 여백(mm), 둥글기(%), 끊김 간격(mm), 선 두께, 화살촉 크기를 조절하고, 가열하는 곳 아래에 위쪽 화살표 세 개와 '가열'을 넣을 수 있습니다. 결과는 선택한 개체와 따로 된 그룹이며 미리보기를 보면서 옮길 수 있습니다.", requires: "대류를 그릴 용기 하나를 선택합니다.", tags: ["과학", "물리", "지구과학", "중학교", "대류", "열의 이동"] },
