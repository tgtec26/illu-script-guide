const scripts = [
  ...
  { id: "punnett-square", category: "도형", name: "퍼넷 사각형", file: "01_도형/Object_PunnettSquare.jsx", summary: "두 어버이의 유전자형(Rr, RrYy, 중간 유전 RW)을 넣으면 생식세포 조합과 자손 유전자형을 표 또는 교과서식 마름모로 그립니다. 같은 생식세포 합치기, 생식세포 원, 표현형 음영, 칸·글자 크기와 위치를 조절합니다.", requires: "선택 없이 실행합니다. 화면 가운데에 그립니다.", tags: ["과학", "생물", "유전", "멘델"] },
  {
    id: "weather",
    category: "도형",
    name: "날씨",
    file: "01_도형/Object_Weather.jsx",
    summary: "기권의 층상 구조·기압과 바람·해륙풍과 계절풍을 한 창의 탭으로 묶은 스크립트입니다. 탭마다 옵션을 따로 저장합니다.",
    requires: "선택 없이 실행합니다. 화면 가운데에 그립니다.",
    tags: ["과학", "지구과학", "기권", "기압", "바람", "날씨"],
    tabs: [
      { id: "atmosphere", name: "기권", summary: "높이에 따른 기온 그래프(−100~20°C)에 대류권·성층권·중간권·열권을 나눕니다. 경계(11·50·80km) 점선, 층 이름, 계면 이름, 오존층, 층 음영을 켜고 너비·높이·최고 높이(100~150km)와 높이 눈금(10·20km), 눈금 방향(바깥·안쪽)을 정합니다. 축은 0.4pt 한 패스로 양 끝에 화살표를 달 수 있고(그래프 도구 축 탭과 같은 방식) 기온 선은 0.8pt입니다. 층 묶음 기호를 켜면 그래프 오른쪽에 층마다 영역 중괄호(화살표 7·6) 선을 긋고 그 오른쪽에 층 이름을 씁니다." },
      { id: "pressure", name: "기압과 바람", summary: "북반구 고기압·저기압을 위에서 본 등압선과 바람 화살표(고기압은 시계 방향으로 불어 나가고 저기압은 시계 반대 방향으로 불어 듦) 또는 옆에서 본 하강·상승 기류로 그립니다. 등압선 수·간격·찌그러짐·모양 번호, 바람 화살표 수, 중심 글자(고·저), 기압 값을 정합니다. 바람·기류 화살표는 일러 화살촉(화살표 1)이라 선 두께와 촉 크기(%)를 조절합니다. 옆에서 본 모습은 축을 켜면 지면이 가로축, 왼쪽 끝이 높이 축(0.4pt)이 되고 눈금 수·눈금 방향(바깥·안쪽)·축 끝 화살표를 정합니다." },
      { id: "sea-land-breeze", name: "해륙풍·계절풍", summary: "육지(대륙)와 바다(해양) 단면 위에 순환 화살표를 그립니다. 해풍(낮)·남동 계절풍(여름)은 바다에서 육지로, 육풍(밤)·북서 계절풍(겨울)은 육지에서 바다로 붑니다. 육지·바다 이름, 고기압·저기압, 때(낮·밤·여름·겨울) 표시를 켭니다." }
    ]
  },
  { id: "chem-reaction", category: "도형", name: "화학 반응 모형", file: "01_도형/Object_ChemReaction.jsx", summary: "원자를 겹친 원(공간 채움 모형)으로 그린 분자로 반응 전후를 나타냅니다. 물·암모니아·염화 수소 생성, 메테인·일산화 탄소 연소 가운데 고르고, 반응 전·후 상자에 계수 × 배수만큼 담거나 계수만큼 늘어놓고 +·화살표로 잇습니다. 원자 크기, 원소 기호, 이름, 아래 첨자가 들어간 반응식을 정합니다.", requires: "선택 없이 실행합니다. 화면 가운데에 그립니다.", tags: ["과학", "화학", "반응", "분자", "모형"] },
  { id: "neuron", category: "도형", name: "뉴런", file: "01_도형/Object_Neuron.jsx", summary: "운동·감각·연합 뉴런 모식도와 자극 전달 경로(감각 기관 → 감각 뉴런 → 연합 뉴런 → 운동 뉴런 → 반응 기관)를 그립니다. 길이, 세포체 지름, 말이집, 이름표(가지 돌기·신경 세포체·축삭 돌기·말이집), 자극 전달 방향 화살표를 정합니다.", requires: "선택 없이 실행합니다. 화면 가운데에 그립니다.", tags: ["과학", "생물", "신경", "뉴런"] },
  {
  ...
  },
  {
    ...
    summary: "진자 운동·수평 던지기 포물선·사인 곡선·코일 스프링·다중 섬광·역학적 에너지를 한 창의 탭으로 묶은 스크립트입니다. 앞 네 탭의 코드와 저장 키는 원래 스크립트 그대로입니다.",
    requires: "탭마다 필요한 선택이 다릅니다. 선택에 맞지 않는 탭은 흐리게 표시되고 툴팁에 이유가 적힙니다.",
    ...
    tabs: [
      ...
      { id: "multi-flash", name: "다중 섬광", summary: "같은 시간 간격으로 찍은 물체 위치를 섬광 사진(공과 눈금자) 또는 시간기록 테이프(종이띠와 점)로 그립니다. 처음 간격과 간격 변화(0이면 등속, 양수면 빨라짐·자유 낙하, 음수면 느려짐), 가로·세로 방향, 찍힌 수, 공 지름, 눈금 간격, 시간 표시(0초, 0.1초…)와 운동 방향 화살표를 정합니다.", requires: "선택 없이 실행합니다. 화면 가운데에 그립니다." },
      { id: "mechanical-energy", name: "역학적 에너지", summary: "자유 낙하하는 물체의 위치 에너지와 운동 에너지를 지점별 쌓은 막대 또는 교과서식 삼각형 비율 그림으로 그립니다. 지점 수, 높이·너비·막대 간격, 낙하 물체와 지점 이름(A, B, C…), 범례, 역학적 에너지 선을 정합니다.", requires: "선택 없이 실행합니다. 화면 가운데에 그립니다." }
    ]
  },
  ...
  { id: "light-mixing", category: "도형", name: "빛의 합성", file: "01_도형/Object_LightMixing.jsx", summary: "화면 가운데에 두 모식도 중 하나를 그립니다. 빛의 삼원색은 빨간색(위)·초록색·파란색 원을 정삼각형으로 겹치고, 두 빛이 겹친 곳은 노란색·청록색·자홍색, 셋이 겹친 곳은 흰색으로 칠합니다(겹친 부분은 원을 다른 원으로 클리핑). 원 지름(mm)과 중심 간격(%)으로 겹침을 정하고, 각 영역 가운데에 색 이름을 넣으며 검은 배경을 깔 수 있습니다. 프리즘 분산은 정삼각형 프리즘의 왼쪽 면으로 들어온 백색광을 굴절률 1.5로 두 번 꺾고, 나오는 빛을 빨간색 → 보라색 일곱 줄로 퍼짐 각만큼 벌립니다. 프리즘 변·입사각·퍼짐·광선 길이를 조절하고, 색 채우기를 끄면 흑백 선으로 그립니다. 문서가 CMYK면 CMYK, RGB면 RGB 색을 씁니다. 미리보기를 보면서 옮길 수 있습니다.", requires: "선택 없이 실행합니다.", tags: ["과학", "물리", "중학교", "빛", "빛의 합성", "삼원색", "프리즘", "분산", "색"] },
  {
    ...
    category: "도형",
    name: "별까지의 거리",
    file: "01_도형/Object_Parallax.jsx",
    summary: "연주 시차와 거리와 밝기 모식도를 한 창의 탭으로 묶은 스크립트입니다. 탭마다 옵션이 따로 있고, 글자(글자 넣기·크기)와 위치 패널만 같이 씁니다. 미리보기를 보면서 옮길 수 있습니다.",
    requires: "선택 없이 실행합니다.",
    tags: ["과학", "지구과학", "중학교", "별", "연주 시차", "거리", "밝기", "파섹"],
    shared: "글자 넣기·글자 크기(pt), 위치 이동을 두 탭이 같이 씁니다.",
    tabs: [
      { id: "parallax", name: "연주 시차", summary: "태양 둘레 납작한 공전 궤도(파선) 양 끝에 6개월 간격 지구 두 개, 태양 위에 별을 놓고, 두 지구에서 별을 지나는 시선을 배경 별 줄까지 늘려 별이 보이는 위치를 표시합니다. 별에서 태양 쪽 선과 지구 쪽 선 사이에 연주 시차 p를, 두 시선 사이에 시차 2p를 호로 표시하고 1 AU 선을 넣습니다. 궤도 반지름·별 거리·궤도 납작함·배경 별 간격(mm)과 별·태양·지구 크기(mm)를 조절하고, 배경 별은 수를 정해 위치·크기를 무작위로 흩으며 랜덤 단추를 누를 때마다 새로 흩습니다." },
      { id: "brightness", name: "거리와 밝기", summary: "광원에서 r, 2r, 3r…에 한 변이 1, 2, 3…배인 정사각형 화면을 입체로 놓고 1, 4, 9…칸으로 나눠 밝기 1, 1/4, 1/9…을 적습니다. 광원에서 나온 네 빛 선이 모든 화면 꼭짓점을 지나고, 화면과 빛 선은 보는 방향에 따라 앞뒤가 맞게 겹칩니다. 시점은 입체 도형(3D 라인)처럼 가로 회전·위아래 기울기·화면 회전(°, 0 단추로 되돌림), 정면·등각·측면·윗면 프리셋, 커스텀 시점 1~4 저장, 원근(시점 거리 mm)으로 바꿉니다. 거리 간격·첫 화면 변·광원 크기(mm)와 화면 수를 조절합니다." }
    ]
  },
  { id: "earth-layers", category: "도형", name: "지구 내부 구조", file: "01_도형/Object_EarthLayers.jsx", summary: "화면 가운데에 지각·맨틀·외핵·내핵 단면을 그립니다. 경계는 실제 깊이 비율(2900 km, 5100 km, 중심 6400 km)을 따르고, 너무 얇은 지각은 반지름에 대한 %로 두께를 과장합니다. 창 맨 위 탭으로 방식을 고릅니다. 평면은 단면 각도로 정하는 부채꼴이며, 360°(원)·180°(반원)·90°(1/4)는 라디오 단추로 고르고 그 밖의 각은 각도(°) 행에 적습니다. 3D 절단은 시점(기울기·돌리기)에서 본 입체로, 절개한 구(절단 각도만큼 쐐기를 잘라낸 구, 180°면 반구 단면)와 잘라낸 조각(쐐기 조각만, 위쪽 반만 선택)을 고르고 절개 방향을 돌립니다. 반구 분리는 지각·맨틀·외핵을 안쪽 층이 빠져 속이 파인 반구 껍질로, 내핵을 입체 음영이 있는 구로 그리고, 손잡이 4개짜리 슬라이더(또는 숫자 칸)로 층마다 가로 위치(mm)를 따로 정하며 단면 폭(%)을 조절합니다. 글자는 한글은 Spoqa, 숫자·영문은 GSMediumB1으로 나뉩니다. 층마다 음영(K)을 넣고, 45° 방향 각 층 가운데에서 오른쪽으로 지시선을 뽑아 이름(원하면 고체·액체 상태도)이나 기호(지각부터 A B C·ⓐ ⓑ ⓒ·㉠ ㉡ ㉢, 원문자는 바탕체)를 붙이며, 평면에서는 오른쪽 가로 반지름 아래에 깊이(0, 2900, 5100, 6400 km)를 적습니다. 이름이 가까우면 세로로 벌려 겹치지 않게 합니다. 반지름·지시선 길이·글자 크기를 조절하며 미리보기를 보면서 옮길 수 있습니다.", requires: "선택 없이 실행합니다.", tags: ["과학", "지구과학", "중학교", "지권", "지구 내부", "지각", "맨틀", "외핵", "내핵"] },
  { id: "magnetic-field", category: "도형", name: "자기장", file: "01_도형/Object_MagneticField.jsx", summary: "화면 가운데에 자기력선 모식도를 그립니다. 막대자석은 N극(진한 회색)·S극(연한 회색) 막대 둘레에 두 극을 점 극으로 둔 자기장을 따라간 자기력선을 그리고, N극에서 나와 S극으로 들어가는 방향으로 화살촉을 붙입니다. 직선 도선은 위에서 본 단면(⊙ 나오는 전류, ⊗ 들어가는 전류) 둘레에 바깥으로 갈수록 간격이 넓어지는 동심원을 그리고 오른손 법칙 방향으로 화살촉을 붙입니다. 코일은 옆에서 본 단면(위·아래 줄 도선 기호가 반대)에 안쪽은 나란한 직선, 바깥은 막대자석처럼 도는 자기력선을 그리고, 전류 방향에 따라 N·S극 위치가 바뀝니다. 길이·두께(mm), 막대자석 코너 둥글기(mm), 감은 수, 선 수, 그리는 범위(%), 화살촉·N·S 글자를 조절하며 미리보기를 보면서 옮길 수 있습니다.", requires: "선택 없이 실행합니다.", tags: ["과학", "물리", "중학교", "자기장", "자기력선", "막대자석", "전류의 자기 작용", "코일", "오른손 법칙"] },
  { id: "electrostatics", category: "도형", name: "정전기 (검전기·정전기 유도)", file: "01_도형/Object_Electrostatics.jsx", summary: "화면 가운데에 검전기나 정전기 유도 모식도를 그립니다. 검전기는 살짝 위에서 본 모습으로, 목과 둥근 바닥이 있는 유리병, 원통 마개와 기둥, 둥근 금속판, 금속 막대와 막대 끝 금속박 두 장을 단색 음영으로 그리고, 상태를 고릅니다. '대전 안 됨'은 금속박이 닫히고 +−가 짝지어 있고, '대전체를 가까이'는 대전체 막대가 금속판 위로 다가와 금속판에 반대 전하·금속박에 같은 전하가 모여 금속박이 벌어지며, '접촉 후'는 검전기 전체가 대전체와 같은 전하로 대전되어 벌어집니다. 금속 막대 유도는 대전체에 가까운 A쪽에 반대 전하, 먼 B쪽에 같은 전하를 놓습니다. 대전체 전하(+, −), 크기, 금속박 벌어짐 각, 전하 기호 크기와 원 테두리, 이름을 조절하며 미리보기를 보면서 옮길 수 있습니다.", requires: "선택 없이 실행합니다.", tags: ["과학", "물리", "중학교", "정전기", "검전기", "정전기 유도", "대전", "전하"] },
  ...
  { id: "galaxy", category: "도형", name: "우리은하·성단", file: "01_도형/Object_Galaxy.jsx", summary: "화면 가운데에 우리은하나 성단을 점(별)으로 그립니다. 위에서 본 모습은 가로로 긴 중심부와 로그 나선을 따라 흩은 나선팔(팔 수·감긴 정도)이고, 태양계를 중심에서 반지름 60% 자리에 놓아 '약 3만 광년'을 표시합니다. 옆에서 본 모습은 얇은 원반, 볼록한 중심부, 둘레 헤일로의 구상 성단이고 지름에 '약 10만 광년'을 표시합니다. 성단은 별이 적고 흩어진 산개 성단과 별이 많고 가운데로 빽빽한 구상 성단을 나란히 그립니다. 지름(mm)·별 수·별 크기·배치 번호(같은 번호면 같은 모양)를 조절하고 검은 배경(별은 흰색)·태양계·거리·이름을 켜고 끄며 미리보기를 보면서 옮길 수 있습니다.", requires: "선택 없이 실행합니다.", tags: ["과학", "지구과학", "중학교", "우리은하", "은하", "나선팔", "성단", "산개 성단", "구상 성단"] },
  {
    ...
    category: "도형",
    name: "별의 일주 운동",
    file: "01_도형/Object_StarTrails.jsx",
    summary: "화면 가운데에 방향별 하늘의 별 궤적을 그립니다. 한 시간에 15°씩 돌도록 관측 시간(h)으로 궤적 길이를 정합니다. 창 맨 위 탭으로 교과서 모식도(개념도)와 실제 별자리(실제 별)를 고릅니다. 방향(북·동·남·서)·크기(mm)·관측 시간·위도, 화살촉 크기(%)·지평선과 방위 글자·글자 크기, 위치는 두 탭이 같이 쓰며, 미리보기를 보면서 옮길 수 있습니다.",
    requires: "선택 없이 실행합니다.",
    tags: ["과학", "지구과학", "중학교", "일주 운동", "별", "북극성", "지구의 자전", "계절별 별자리", "북두칠성", "카시오페이아", "오리온자리"],
    shared: "방향(북쪽·동쪽·남쪽·서쪽), 크기(mm), 관측 시간(h), 위도(°), 화살촉 크기(%), 지평선·방위 글자, 글자 크기(pt), 위치 이동을 두 탭이 같이 씁니다.",
    tabs: [
      { id: "schematic", name: "개념도", summary: "교과서 모식도입니다. 북쪽 하늘은 북극성을 가운데 둔 시계 반대 방향 동심원 호(시작 각은 배치 번호로 흩음)이고, 가장 바깥 호에 반지름 파선과 각도(예: 45°)를 표시할 수 있습니다. 동쪽 하늘은 오른쪽 위로 떠오르고 서쪽 하늘은 오른쪽 아래로 지는 평행선으로, 지평선과 이루는 각은 90° − 위도입니다. 남쪽 하늘은 동에서 서로 가는 동심원 호입니다. 별 수와 배치 번호를 조절합니다." },
      { id: "real-stars", name: "실제 별", summary: "실제 별의 적경·적위로 계절 대표일(봄 4월 15일·여름 7월 15일·가을 10월 15일·겨울 1월 15일)의 시각(기본 21시, 한국 표준시)에 서울(위도 37.5°·동경 127°)에서 보이는 자리와 궤적을 계산해 그립니다. 계절을 고르면 그 계절의 별자리(봄: 사자·처녀·목동, 여름: 전갈·여름의 대삼각형·백조, 가을: 페가수스 사각형·안드로메다·포말하우트, 겨울: 오리온·겨울의 대삼각형·대육각형)와 사계절 북쪽 별자리(북두칠성·카시오페이아·작은곰)가 목록에 나오고, 별자리를 고르면 그 시각에 별자리가 있는 방향이 저절로 선택됩니다(방향 라디오로 바꿀 수 있음). 같은 시각이라도 계절에 따라 북두칠성이 북극성 위·아래에 오는 것을 보여 줍니다. 시야는 카메라(직선 투영)로, 북쪽은 천구 북극을 가운데 두어 정확한 동심원이 되고 동·남·서는 고도 30°를 가운데 둡니다. 지평선 아래는 자릅니다. 별 이름, 별자리 선, 밝을수록 큰 별 점을 켜고 끌 수 있습니다." }
    ] },
  { id: "moon-phase", category: "도형", name: "달의 위상·일식·월식", file: "01_도형/Object_MoonPhase.jsx", summary: "화면 가운데에 세 가지 모식도 중 하나를 그립니다. 위상: 지구 둘레 공전 궤도(파선)에 달을 8곳 또는 4곳 놓고 태양 반대쪽 반을 어둡게 칠하며, 궤도 바깥에 지구(북반구)에서 본 모양과 이름(삭·초승달·상현달·망·하현달·그믐달)이나 기호(A~H)를 붙입니다. 태양 쪽(오른쪽·왼쪽)에서 오는 햇빛 화살표도 넣어 굵기(pt)·간격(mm)·수·색(K)을 조절하고, 궤도 반지름과 달·지구 지름(mm)을 조절합니다. 일식(태양–달–지구)과 월식(태양–지구–달)은 너비(mm)에 맞춰 일직선으로 놓고 본그림자·반그림자(K)와 태양 가장자리에서 오는 광선을 그립니다. 어두운 면 색(K)과 글자 크기는 공통이며, 미리보기를 보면서 옮길 수 있습니다.", requires: "선택 없이 실행합니다.", tags: ["과학", "지구과학", "중학교", "달", "위상", "일식", "월식", "태양계"] },
  { id: "lab-glassware", category: "도형", name: "실험 기구", file: "01_도형/Object_LabGlassware.jsx", summary: "비커, 삼각 플라스크, 시험관, 눈금실린더, 주사기, 온도계를 그립니다. 축에 나란한 사각형을 선택하면 그 자리·크기에, 선택이 없으면 화면 가운데에 종류별 기본 크기로 그리며 너비·높이(mm)는 다이얼로그에서 고칩니다. 액체를 넣으면 바닥부터 높이(%)까지 채운 면(K)과 수면 선이 생기고, 주사기는 피스톤 위치, 온도계는 액주 높이를 같은 행에서 조절합니다. 눈금을 켜면 칸 수만큼(5칸마다 길게) 넣습니다. 유리 두께(mm)를 올리면 유리 벽이 흰 안쪽의 두 겹 선이 되어 바깥쪽으로 두꺼워지고, 열린 끝은 둥글게 조금 더 두꺼워집니다(0이면 한 줄 선, 받침·날개·피스톤은 그대로). 액체 면('액체')과 주사기 속 공간('기체')은 닫힌 패스로 남아 입자 상태 모형으로 바로 채울 수 있습니다. 선은 0.3pt 검정이고 미리보기를 보면서 옮길 수 있습니다.", requires: "축에 나란한 사각형 하나를 선택하거나, 아무것도 선택하지 않고 실행합니다.", tags: ["과학", "화학", "중학교", "실험", "비커", "플라스크", "시험관", "눈금실린더", "주사기", "온도계"] },
  { id: "particle-state", category: "도형", name: "입자 상태 모형", file: "01_도형/Object_ParticleState.jsx", summary: "선택한 닫힌 패스(사각형·원·용기 안쪽 모양) 안을 물질의 세 가지 상태 입자 배열로 채웁니다. 고체는 촘촘한 육방 격자, 액체는 조금 느슨하고 불규칙한 배열로 바닥부터 채우는 높이(%)까지, 기체는 입자 수만큼 서로 멀리 떨어뜨려 흩습니다. 입자 지름(mm)·색(K)을 정하고, 배치 번호를 바꾸면 다른 배치가 나옵니다. 운동 화살표는 정한 비율(%)의 입자에 무작위 방향으로 붙이고 길이·두께(pt)·색(K)·화살촉 크기를 조절합니다. 입자는 도형 밖으로 나가지 않으며, 원래 도형은 그대로 두고 그 위에 입자 그룹을 얹습니다. 미리보기를 보면서 가로·세로로 옮길 수 있습니다.", requires: "닫힌 패스 하나를 선택합니다.", tags: ["과학", "화학", "물리", "중학교", "입자", "상태 변화", "고체", "액체", "기체", "열팽창"] },
  ...
  { id: "u-tube", category: "도형", name: "J자관·U자관", file: "01_도형/Object_UTube.jsx", summary: "선택한 사각형 자리에 화학 기체 압력 실험용 J자관이나 생명과학 삼투 실험용 U자관을 그립니다. 사각형의 너비·높이가 관 전체 크기가 되고 다이얼로그에서 고칠 수 있습니다. J자관은 왼쪽 관이 시험관 바닥처럼 반원으로 막힌 채 오른쪽 관보다 높이 차(mm)만큼 낮고, U자관은 두 관이 모두 열려 있고 같은 높이입니다. 관 두께(안쪽 폭, mm)를 정하고, 유리 두께(mm)를 올리면 관 벽이 바깥쪽으로 두꺼운 두 겹 선(흰 안쪽, 열린 끝은 둥근 알)이 됩니다(0이면 한 줄 선). 바닥부터 채우는 액체의 높이를 관 바닥 기준 mm로 조절하며(좌우 같은 높이 체크를 풀면 왼쪽·오른쪽 따로), 액체 색은 K 10 단위로 고릅니다. 굽은 바닥 가운데에 반투과성막(세로 파선 2pt·1pt)을 넣고 굵기(pt)를 정할 수 있으며, 미리보기를 보면서 가로·세로로 옮깁니다. 관·액체 선은 0.3pt 검정이며, 확인하면 원본 사각형은 지워지고 액체·관(·막)이 든 그룹 하나가 남습니다.", requires: "가로·세로 변이 축에 나란한 사각형 하나를 선택합니다.", tags: ["과학", "화학", "생물", "삼투", "J자관", "U자관", "수은", "기체"] },
  ...
  { id: "phospholipid-bilayer", category: "도형", name: "인지질 2중층", file: "01_도형/Object_PhospholipidBilayer.jsx", summary: "기준선과 인지질 하나를 선택하면 선의 법선 방향으로 인지질을 위아래 두 층으로 세웁니다. 곡선에서는 바깥층 개수를 자동으로 늘려 머리 간격을 맞춥니다.", tags: ["과학", "세포막"] },
  {
    ...
    category: "도형",
    name: "렌즈·거울",
    file: "01_도형/Object_LensMirror.jsx",
    summary: "렌즈·거울 작도와 평면거울의 상을 한 창의 탭으로 묶은 스크립트입니다. 두 탭은 서로 다른 그림이라 옵션을 공유하지 않고, 각 탭의 저장 옵션은 원래 스크립트 그대로 이어집니다. 도형을 선택하고 실행하면 렌즈·거울 탭(상 작도)이 열립니다.",
    requires: "렌즈·거울 탭: 선택 없이 실행하면 평행 광선, 도형을 선택하면 그 도형을 물체로 상 작도. 평면거울 탭: 선택 없이 실행합니다.",
    tags: ["과학", "물리", "중학교", "빛", "렌즈", "거울", "광학", "실상", "허상", "반사", "평면거울", "입사각", "반사각"],
    tabs: [
      { id: "lens", name: "렌즈·거울", summary: "볼록 렌즈·오목 렌즈·볼록 거울·오목 거울을 광축·초점·광선과 함께 그립니다. 렌즈는 높이·가운데 두께·가장자리 두께(평평한 테두리, 0이면 뾰족한 끝), 거울은 높이·휨과 뒷면 빗금을 미리보기로 조절하고, 초점 거리는 모양과 맞물립니다(렌즈 f = 호 반지름 ÷ 2(굴절률−1), 거울 f = 호 반지름 ÷ 2 — 모양을 바꾸면 초점 거리가, 초점 거리를 바꾸면 두꺼운 쪽 두께·휨이 따라옴). 초점은 1mm 점 + 이탤릭 F. 아무것도 선택하지 않고 실행하면 왼쪽에서 오는 평행 광선이 렌즈 중심선에서 꺾이거나 거울면에서 반사해 초점으로 모이거나 퍼지고(가상 경로는 파선), 도형을 선택하고 실행하면 그 도형을 물체로 삼아 도형 아래에 광축을 놓고 주광선 3개와 상(실상은 거꾸로, 허상은 불투명도 50%)을 렌즈 공식대로 작도하고, 물체·실상·허상 이름 글자(GSMediumB1, 도형 가운데 1mm 간격)도 붙일 수 있습니다. 물체 거리, 광선 실선/파선·두께, 화살촉 크기와 중심선에서의 위치를 고릅니다." },
      { id: "plane", name: "평면거울", summary: "화면 가운데에 평면거울에 비친 상의 작도를 그립니다. 뒷면에 빗금을 친 세로 거울 앞 '물체 거리'에 물체(위 화살표)를, 거울 뒤 같은 거리에 같은 크기의 상(회색 파선 화살표)을 놓습니다. 물체 꼭대기·아래 끝에서 나온 빛이 거울에서 반사해 눈으로 들어가는 광선을 긋고(반사점은 눈과 상을 잇는 직선이 거울과 만나는 점이라 입사각 = 반사각), 거울 뒤로는 상까지 파선을 잇습니다. 반사점마다 파선 법선과 입사각(i)·반사각(r) 호를 넣을 수 있고, 거울 높이·물체 거리·물체 높이·눈 거리·눈 높이(mm)를 조절합니다. 반사점이 거울 밖이면 그 광선은 그리지 않습니다. 미리보기를 보면서 옮길 수 있습니다." }
    ]
  },
