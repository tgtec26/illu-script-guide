const scripts = [
  ...
  { id: "meiosis", category: "도형", name: "감수 분열", file: "01_도형/Object_Meiosis.jsx", summary: "선택한 사각형을 비계로 감수 분열 과정(G1기 → 중기 1 → 중기 2 → 딸세포 → 정자)을 그립니다. 줄마다 세로 간격, 딸세포 사이 가로 간격, 단계별 지름, 정자 머리·꼬리 모양과 회전, 전체 위치를 조절하면 중기 2 위치와 화살표 각도가 따라옵니다.", tags: ["과학", "다이어그램"] },
  ...
  { id: "chromosome", category: "도형", name: "염색체 모형", file: "01_도형/Object_Chromosome.jsx", summary: "핵형 분석 설명용 염색체 모형을 최대 4개까지 한 번에 그립니다. 탭마다 염색 분체 수(1·2개)·전체 길이·두께·중심절 위치와 지름·벌림 각도·p암/q암 휨·내부 음영을 따로 정하고, 켜진 염색체가 선택 개체(없으면 아트보드) 중심에 가로로 나란히 놓입니다. 암은 중심절 쪽이 좁고 끝이 둥근 형태, 중심절은 흰 원, 외곽선 0.3pt입니다.", tags: ["과학", "생물", "핵형"] },
