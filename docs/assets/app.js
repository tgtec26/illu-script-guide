const scripts = [
  ...
  { id: "cloud", category: "도형", name: "구름", file: "01_도형/Object_Cloud.jsx", summary: "직접 그려 둔 구름 9종(적운·층적운·적란운 등, 구름 K0 · 그림자 1 K20 · 그림자 2 K40 · 외곽선 0.3pt)을 3×3 버튼으로 골라 선택한 사각형 안에 그립니다. 모양은 원본 그대로이고 크기(비율 유지 또는 꽉 채우기), 세 면의 K값(10 단위), 선 표시만 조절합니다. 외곽선은 크기를 바꿔도 0.3pt를 지킵니다. 모양 데이터는 같은 폴더의 Object_Cloud_library.jsxinc에 있고 tools/cloud-library로 다시 만들 수 있습니다. 확인하면 원본 사각형은 지워집니다.", tags: ["날씨", "구름", "하늘", "기상", "음영", "라이브러리"] },
