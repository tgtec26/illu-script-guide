const scripts = [
  ...
  { id: "energy-flow", category: "도형", name: "에너지 흐름 화살표", file: "01_도형/Object_EnergyFlow.jsx", summary: "선택한 사각형을 연료 에너지 상자로 삼아 그 위로 갈라져 올라가는 에너지 흐름 화살표를 그립니다. 상자 이름·값(숫자 뒤에 이탤릭 E 자동)을 넣고 2·3·4개로 나눈 뒤 구간 슬라이더나 값 입력으로 비율을 정하며, 항목마다 이름과 ?로 표시 여부를 고릅니다. 첫 화살표는 12시 방향으로 곧게, 마지막은 90° 꺾여 3시 방향으로 나가고 가운데 화살표는 각도를 조절합니다. 화살표마다 꺾임 높이·길이·꺾임 반지름·음영(K%), 공통으로 상자 폭·높이, 화살촉 길이·폭(몸통 폭 대비 %라 닮은꼴), 글자 크기, 값 높이, 위치를 조절합니다. 확인하면 원본 사각형은 지워집니다.", tags: ["과학", "에너지", "화살표", "다이어그램"] },
