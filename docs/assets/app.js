const scripts = [
  ...
  { id: "punnett-square", category: "도형", name: "퍼넷 사각형", file: "01_도형/Object_PunnettSquare.jsx", summary: "두 어버이의 유전자형(Rr, RrYy, 중간 유전 RW)을 넣으면 생식세포 조합과 자손 유전자형을 표 또는 교과서식 마름모로 그립니다. 같은 생식세포 합치기, 생식세포 원, 표현형 음영, 칸·글자 크기와 위치를 조절합니다.", requires: "선택 없이 실행합니다. 화면 가운데에 그립니다.", tags: ["과학", "생물", "유전", "멘델"] },
  {
    ...
    tabs: [
      ...
      { id: "pressure", name: "기압과 바람", summary: "북반구 고기압·저기압을 위에서 본 등압선과 바람 화살표(고기압은 시계 방향으로 불어 나가고 저기압은 시계 반대 방향으로 불어 듦) 또는 옆에서 본 하강·상승 기류로 그립니다. 등압선 수·간격·찌그러짐·모양 번호, 바람 화살표 수, 중심 글자(고·저), 기압 값을 정합니다." },
