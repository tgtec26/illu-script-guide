...
(function() {
    ...
    function createCabinet(frontFace, depth, dirX, makeGroup) {
        ...
        var hiddenGroup = makeHiddenLines(frontFace, bounds, depth, dirX);
    ...
    function makeHiddenLines(frontFace, bounds, depth, dirX) {
        var dx = depth * dirX;
        var dy = depth;
        var hiddenX = dirX > 0 ? bounds[0] : bounds[2]; // 앞면에 가려지는 쪽 세로 모서리
        var otherX = dirX > 0 ? bounds[2] : bounds[0];
