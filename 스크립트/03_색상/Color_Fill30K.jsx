/*
  Illustrator Script: Force Fill 30K (Pure Black Fixed)
  Description: 선택된 객체의 면(Fill)을 CMY 혼합 없는 순수 30% 회색(K=30)으로 변경합니다.
*/
...
(function() {
    ...
    if (doc.documentColorSpace === DocumentColorSpace.CMYK) {
        // [핵심] GrayColor 객체를 사용하여 순수 K값만 30% 적용
        targetColor = new GrayColor();
        targetColor.gray = 30; // K=30
    } else {
        // RGB 모드: 30% Black = 70% White (밝기)
        var rgbVal = 255 * 0.7; 
