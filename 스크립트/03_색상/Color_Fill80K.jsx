/*
  Illustrator Script: Force Fill 80K (Pure Black Fixed)
  Description: 선택된 객체의 면(Fill)을 CMY 혼합 없는 순수 80% 회색(K=80)으로 변경합니다.
*/
...
(function() {
    ...
    if (doc.documentColorSpace === DocumentColorSpace.CMYK) {
        // [핵심] GrayColor 객체를 사용하여 순수 K값만 80% 적용
        targetColor = new GrayColor();
        targetColor.gray = 80; // K=80
    } else {
        // RGB 모드: 80% Black = 20% White (어두움)
        var rgbVal = 255 * 0.2; 
